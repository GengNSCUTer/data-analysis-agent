#!/usr/bin/env python3
"""Verify the Qwen3.5-4B TheLook v2 pair before any Gold access."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(json.dumps({"case_count": marker["case_count"], "verified": True}))
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"Qwen3.5-4B matching verification error: {exc}", file=sys.stderr)
