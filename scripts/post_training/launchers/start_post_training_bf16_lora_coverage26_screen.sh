...
# One controlled 26-step bf16 LoRA run. It differs from the QLoRA counterpart
# only in frozen-base storage precision; outputs remain outside the worktree.
...
RUN_DIRECTORY="${RUN_DIRECTORY:-/disk2/gengnan/data-analysis-agent-data/experiments/qwen25coder15b-bf16-lora-coverage26-v1-20260825}"
...
echo "[experiment] bf16_lora_coverage26"
...
"${QLORA_PYTHON}" "${ROOT}/scripts/run_post_training_sft_smoke.py" \
  ...
  --experiment-label bf16_lora_coverage26_v1
