...
# Generate only the Qwen3.5-2B LoRA Adapter side of the protected TheLook v2
# pair.  The historical 600-case Base output is deliberately reused rather
# than regenerated.  Gold SQL, PostgreSQL execution, and denotation scoring
# are separate later commands after matching verification succeeds.
...
# AGENTS.md mapping: logical CUDA device 1 is physical nvidia-smi GPU 3.
...
MODEL_DIR="${MODEL_DIR:-${DATA_ROOT}/models/qwen3.5-2b-instruct-15852e8c16360a2fea060d615a32b45270f8a8fc}"
ADAPTER_DIR="${ADAPTER_DIR:-${DATA_ROOT}/experiments/qwen35-2b-olist-domain-sft-v1-20260910/adapter_final}"
RUN_ROOT="${RUN_ROOT:-${DATA_ROOT}/experiments/qwen35-2b-thelook-v2-matching-v1-20260911}"
...
echo "[experiment] qwen35_2b_thelook_v2_adapter_matching_v1"
...
"${EVAL_PYTHON}" "${ROOT}/scripts/post_training/evaluation/run_qwen35_2b_thelook_v2_adapter_generation.py" \
