...
# Canonical CSpider 1,536-token bf16 LoRA training launcher.  It is intentionally
# a launch-only script: this review round does not execute it.
...
RUN_DIRECTORY="${RUN_DIRECTORY:-/disk2/gengnan/data-analysis-agent-data/experiments/qwen25coder15b-cspider-bf16-lora-length1536-v1}"
...
echo "[experiment] cspider_bf16_lora_length1536_v1"
...
"${TRAIN_PYTHON}" "${ROOT}/scripts/run_post_training_sft_smoke.py" \
  ...
  --experiment-label cspider_bf16_lora_length1536_v1
