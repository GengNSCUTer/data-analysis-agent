...
# Frozen Olist Medium v1 two-epoch bf16 LoRA training.
# All data, checkpoints and logs remain outside the Git worktree.
...
RUN_DIR="${RUN_DIR:-/disk2/gengnan/data-analysis-agent-data/experiments/qwen25coder15b-olist-medium-bf16-lora-full2epoch-v1-20260904}"
...
echo "[experiment] olist_medium_bf16_lora_full2epoch_v1"
...
PYTHONPATH="${ROOT}" "${PYTHON}" -m scripts.post_training.training.run_post_training_sft_smoke \
  ...
  --experiment-label olist_medium_bf16_lora_full2epoch_v1
