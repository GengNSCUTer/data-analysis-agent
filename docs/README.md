...
- [`post-training/data/thelook-v2-metric-scenario-candidates.md`](post-training/data/thelook-v2-metric-scenario-candidates.md)：基于只读聚合画像的 TheLook v2 候选指标、事实域、维度/行数边界和明确排除项；尚未冻结为 Catalog 或评测集。
