...
- [`post-training/data/olist-protected-family-summary-export-v1.md`](post-training/data/olist-protected-family-summary-export-v1.md)：仓库外 protected family fingerprint summary 的受限导出与证据边界；导出器已实现，尚未处理真实 holdout。
