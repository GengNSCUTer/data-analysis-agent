...
def _metric_definitions() -> dict[str, MetricSqlDefinition]:
    ...
    return {
        ...
        "average_order_value": MetricSqlDefinition("average_order_value", purchase, "purchase", ("fact_orders", "fact_order_items"), "AVG(order_totals.order_total)", "AVG(order_totals.order_total)", (status,), "valid orders only (excludes canceled/unavailable); order-level price sum then average"),
